...
public class MapManager
{
    ...
    // 开始点和下一个点 算出方向  然后判断箭头方向
    public BlockDirection GetDirection(AStarPoint start, AStarPoint next)
    {
